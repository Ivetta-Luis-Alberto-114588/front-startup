...
describe('CartService', () => {
  ...
  describe('removeItem', () => {    it('should remove item from cart successfully', () => {
      const productId = 'prod1';
      const updatedCart = { 
        ...mockCart, 
        items: [], 
  ...
  describe('clearCart', () => {    it('should clear cart successfully', () => {
      const emptyCart = { 
        ...mockCart, 
        items: [], 
        totalItems: 0, 
  ...
  describe('cart state management', () => {    it('should emit cart state changes', () => {
  ...
  describe('error handling', () => {    it('should handle network errors', () => {
      service.getCart().subscribe({
        error: (error) => {
