...
describe('CartPageComponent', () => {
  ...
  describe('loadCart', () => {    it('should load cart successfully', () => {
  ...
  describe('increaseQuantity', () => {    it('should increase item quantity successfully', () => {
  ...
  describe('removeItem', () => {    it('should remove item successfully', () => {
