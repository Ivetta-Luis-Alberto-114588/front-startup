// src/app/features/payments/components/payment-failure/payment-failure.component.ts
...
export class PaymentFailureComponent implements OnInit, OnDestroy { // Implementar interfaces
